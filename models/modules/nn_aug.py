...
class ColorAugmentation(nn.Module):
    def __init__(self, n_classes=10, scale=1, hidden=128, n_dim=96, dropout_ratio=0.8, with_context=False):
        super().__init__()
...
class GeometricAugmentation(nn.Module):
    def __init__(self, n_classes=10, scale=0.5, n_dim=96, dropout_ratio=0.8, with_context=False):
        super().__init__()
